...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set(
        'n',
        '<leader>sf',
        function() builtin.fd { find_command = { 'fd', '--exclude', '.git', '--hidden', '--type', 'f' } } end,
        { desc = '[S]earch [F]iles' }
      )
...

  {
    ...
    build = 'cd app && yarn install && cd .. && git checkout .',
  ...
  -- LSP Plugins
  {
    ...
    opts = {
      ...
      enabled = function(root_dir) return vim.g.lazydev_enabled == true end,
    },
  },
  {
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'fish', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'toml' },
      ...
      highlight = {
        ...
        -- to disable loading files larger than 100 KB
